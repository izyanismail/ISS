   ...
   <div  style="background-color:rgba(0,0,0,0.9); height: 80px; width:100;">
    ...
    <div  style="background-color:rgba(255,255,255,0.6); height: 530px; width:100;">
       ...
       <table align="center">
        <tr>
         <td>
             <asp:GridView ID="GridView2" runat="server" Font-Bold="True" Font-Names="Verdana"  
              style="text-align:center;width: auto;padding: 0px" CellPadding="8">
              <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
             </asp:GridView>
         </td>
         <td>
            <asp:GridView ID="GridView1" runat="server" Font-Bold="True" Font-Names="Verdana"  
             style="text-align:center;width: auto;padding: 0px" CellPadding="8">
             <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
            </asp:GridView>
         </td>
